...
When we have more than one memory stored, I imagined that the system as a whole would work like a spring that has more than one preferred state, and it exists (video below)!
